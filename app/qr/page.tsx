      ...
      <div className="no-print" style={{ background: '#030712', padding: '32px 16px 0' }}>
        <div style={{ maxWidth: 440, margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ color: '#9ca3af', fontSize: '0.875rem', marginTop: 4 }}>
            プレイヤー {QR_CODE_IDS.length}枚（全モード共通）
          </p>
          ...
          <div style={{
            ...
            <p style={{ marginTop: 8, color: '#a78bfa', fontWeight: 700 }}>👹 ハンティングモード</p>
            <p>• 封印ポイントはゲーム開始時に GPS で自動配置されます</p>
            <p>• 封印ポイントに近づくとボタンが出現 → ホールドで解除（印刷QR不要）</p>
          </div>
        </div>
      </div>
